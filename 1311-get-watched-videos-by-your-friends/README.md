<h2><a href="https://leetcode.com/problems/get-watched-videos-by-your-friends/?envType=problem-list-v2&envId=graph">1436. Get Watched Videos by Your Friends</a></h2><h3>Medium</h3><hr><p>There are <code>n</code> people, each person has a unique <em>id</em> between <code>0</code> and <code>n-1</code>. Given the arrays <code>watchedVideos</code> and <code>friends</code>, where <code>watchedVideos[i]</code> and <code>friends[i]</code> contain the list of watched videos and the list of friends respectively for the person with <code>id = i</code>.</p>
