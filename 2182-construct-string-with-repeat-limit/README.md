<h2><a href="https://leetcode.com/problems/construct-string-with-repeat-limit/?envType=problem-list-v2&envId=greedy">2300. Construct String With Repeat Limit</a></h2><h3>Medium</h3><hr><p>You are given a string <code>s</code> and an integer <code>repeatLimit</code>. Construct a new string <code>repeatLimitedString</code> using the characters of <code>s</code> such that no letter appears <strong>more than</strong> <code>repeatLimit</code> times <strong>in a row</strong>. You do <strong>not</strong> have to use all characters from <code>s</code>.</p>
